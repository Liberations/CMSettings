.class public Lcom/android/stockssettings/ButtonSettings;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 765
    new-instance v0, Lcom/android/stockssettings/ButtonSettings$2;

    invoke-direct {v0}, Lcom/android/stockssettings/ButtonSettings$2;-><init>()V

    sput-object v0, Lcom/android/stockssettings/ButtonSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/android/stockssettings/search/Indexable$SearchIndexProvider;
...
.method static synthetic access$000(Lcom/android/stockssettings/ButtonSettings;)Landroid/preference/SwitchPreference;
    .locals 1
    .param p0, "x0"    # Lcom/android/stockssettings/ButtonSettings;

    .prologue
    .line 60
    iget-object v0, p0, Lcom/android/stockssettings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/stockssettings/ButtonSettings;)Landroid/preference/PreferenceCategory;
    .locals 1
    .param p0, "x0"    # Lcom/android/stockssettings/ButtonSettings;

    .prologue
    .line 60
    iget-object v0, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/stockssettings/ButtonSettings;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/stockssettings/ButtonSettings;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 60
    invoke-direct {p0, p1}, Lcom/android/stockssettings/ButtonSettings;->updateDisableNavkeysCategories(Z)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/stockssettings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lcom/android/stockssettings/ButtonSettings;
    ...
    .prologue
    .line 60
    invoke-static {p0, p1}, Lcom/android/stockssettings/ButtonSettings;->getPreferencesToRemove(Lcom/android/stockssettings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
...
.method private static getPreferencesToRemove(Lcom/android/stockssettings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
    .locals 35
    .param p0, "settings"    # Lcom/android/stockssettings/ButtonSettings;
    .param p1, "context"    # Landroid/content/Context;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/android/stockssettings/ButtonSettings;",
    ...
    .line 298
    invoke-static/range {p1 .. p1}, Lcom/android/stockssettings/Utils;->isVoiceCapable(Landroid/content/Context;)Z
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/stockssettings/ButtonSettings;->initActionList(Ljava/lang/String;I)Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mHomeLongPressAction:Landroid/preference/ListPreference;
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/stockssettings/ButtonSettings;->initActionList(Ljava/lang/String;I)Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mHomeDoubleTapAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mMenuPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mMenuLongPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mAssistPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mAssistLongPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mAppSwitchPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/stockssettings/ButtonSettings;->mAppSwitchLongPressAction:Landroid/preference/ListPreference;
    ...
    :cond_12
    :goto_16
    invoke-static/range {p1 .. p1}, Lcom/android/stockssettings/Utils;->hasVolumeRocker(Landroid/content/Context;)Z
    ...
    :cond_17
    :goto_1a
    invoke-static/range {p1 .. p1}, Lcom/android/stockssettings/cyanogenmod/ButtonBacklightBrightness;->isButtonSupported(Landroid/content/Context;)Z

    move-result v33

    if-nez v33, :cond_18

    invoke-static/range {p1 .. p1}, Lcom/android/stockssettings/cyanogenmod/ButtonBacklightBrightness;->isKeyboardSupported(Landroid/content/Context;)Z
    ...
    .line 286
    invoke-direct/range {p0 .. p0}, Lcom/android/stockssettings/ButtonSettings;->updateDisableNavkeysOption()V

    .line 287
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/stockssettings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;

    move-object/from16 v33, v0

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/stockssettings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {v0, v1}, Lcom/android/stockssettings/ButtonSettings;->updateDisableNavkeysCategories(Z)V
...
.method private handleActionListChange(Landroid/preference/ListPreference;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 574
    invoke-virtual {p0}, Lcom/android/stockssettings/ButtonSettings;->getContentResolver()Landroid/content/ContentResolver;
...
.method private handleToggleHomeButtonAnswersCallPreferenceClick()V
    ...
    iget-object v0, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
...
.method private handleTogglePowerButtonEndsCallPreferenceClick()V
    ...
    iget-object v0, p0, Lcom/android/stockssettings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
...
.method private initActionList(Ljava/lang/String;I)Landroid/preference/ListPreference;
    ...
    .prologue
    .line 497
    invoke-virtual {p0}, Lcom/android/stockssettings/ButtonSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method private initRecentsLongPressAction(Ljava/lang/String;)Landroid/preference/ListPreference;
    ...
    .prologue
    .line 506
    invoke-virtual/range {p0 .. p0}, Lcom/android/stockssettings/ButtonSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 510
    invoke-virtual/range {p0 .. p0}, Lcom/android/stockssettings/ButtonSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual {v0, v14}, Lcom/android/stockssettings/ButtonSettings;->getString(I)Ljava/lang/String;
    ...
    .line 521
    :goto_0
    invoke-virtual/range {p0 .. p0}, Lcom/android/stockssettings/ButtonSettings;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v0, v15}, Lcom/android/stockssettings/ButtonSettings;->getString(I)Ljava/lang/String;
...
.method public static restoreKeyDisabler(Landroid/content/Context;)V
    ...
    :cond_1
    invoke-static {p0, v1}, Lcom/android/stockssettings/ButtonSettings;->writeDisableNavkeysOption(Landroid/content/Context;Z)V
...
.method private updateDisableNavkeysCategories(Z)V
    ...
    check-cast v3, Lcom/android/stockssettings/cyanogenmod/ButtonBacklightBrightness;

    .line 681
    .local v3, "backlight":Lcom/android/stockssettings/cyanogenmod/ButtonBacklightBrightness;
    if-eqz v3, :cond_0
    ...
    :goto_0
    invoke-virtual {v3, v7}, Lcom/android/stockssettings/cyanogenmod/ButtonBacklightBrightness;->setEnabled(Z)V

    .line 683
    invoke-virtual {v3}, Lcom/android/stockssettings/cyanogenmod/ButtonBacklightBrightness;->updateSummary()V
...
.method private updateDisableNavkeysOption()V
    ...
    .line 656
    invoke-virtual {p0}, Lcom/android/stockssettings/ButtonSettings;->getActivity()Landroid/app/Activity;
    ...
    .local v0, "enabled":Z
    :cond_0
    iget-object v1, p0, Lcom/android/stockssettings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v10}, Lcom/android/stockssettings/ButtonSettings;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {p0, v10}, Lcom/android/stockssettings/ButtonSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v10

    check-cast v10, Landroid/preference/SwitchPreference;

    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mHandler:Landroid/os/Handler;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationBarLeftPref:Landroid/preference/SwitchPreference;

    .line 168
    const-string v10, "navigation_recents_long_press"

    invoke-direct {p0, v10}, Lcom/android/stockssettings/ButtonSettings;->initRecentsLongPressAction(Ljava/lang/String;)Landroid/preference/ListPreference;

    move-result-object v10

    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationRecentsLongPressAction:Landroid/preference/ListPreference;
    ...
    invoke-static {p0, v10}, Lcom/android/stockssettings/ButtonSettings;->getPreferencesToRemove(Lcom/android/stockssettings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v3}, Lcom/android/stockssettings/ButtonSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .line 178
    invoke-virtual {p0, v0}, Lcom/android/stockssettings/ButtonSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    :cond_1
    invoke-virtual {p0, v3}, Lcom/android/stockssettings/ButtonSettings;->removePreference(Ljava/lang/String;)V
    ...
    invoke-static {v10}, Lcom/android/stockssettings/Utils;->hasVolumeRocker(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v10, v1}, Lcom/android/stockssettings/ButtonSettings;->initActionList(Ljava/lang/String;I)Landroid/preference/ListPreference;

    move-result-object v10

    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeKeyCursorControl:Landroid/preference/ListPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;

    .line 200
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;

    if-eqz v10, :cond_3

    .line 201
    iget-object v13, p0, Lcom/android/stockssettings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;
    ...
    :cond_3
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mCameraWakeScreen:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mCameraSleepOnRelease:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mCameraLaunch:Landroid/preference/SwitchPreference;

    .line 215
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mCameraWakeScreen:Landroid/preference/SwitchPreference;

    if-eqz v10, :cond_5

    .line 216
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mCameraSleepOnRelease:Landroid/preference/SwitchPreference;

    if-eqz v10, :cond_5

    invoke-virtual {p0}, Lcom/android/stockssettings/ButtonSettings;->getResources()Landroid/content/res/Resources;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeWakeScreen:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeMusicControls:Landroid/preference/SwitchPreference;
    ...
    iput-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeControlRingStream:Landroid/preference/SwitchPreference;
    ...
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeControlRingStream:Landroid/preference/SwitchPreference;
    ...
    .line 233
    :cond_7
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeWakeScreen:Landroid/preference/SwitchPreference;

    if-eqz v10, :cond_8

    .line 234
    iget-object v10, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeMusicControls:Landroid/preference/SwitchPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 579
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeLongPressAction:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, v4, p2, v5}, Lcom/android/stockssettings/ButtonSettings;->handleActionListChange(Landroid/preference/ListPreference;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 583
    :cond_0
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeDoubleTapAction:Landroid/preference/ListPreference;
    ...
    .line 587
    :cond_1
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mMenuPressAction:Landroid/preference/ListPreference;
    ...
    .line 591
    :cond_2
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mMenuLongPressAction:Landroid/preference/ListPreference;
    ...
    .line 595
    :cond_3
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mAssistPressAction:Landroid/preference/ListPreference;
    ...
    .line 599
    :cond_4
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mAssistLongPressAction:Landroid/preference/ListPreference;
    ...
    .line 603
    :cond_5
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mAppSwitchPressAction:Landroid/preference/ListPreference;
    ...
    .line 607
    :cond_6
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mAppSwitchLongPressAction:Landroid/preference/ListPreference;
    ...
    .line 611
    :cond_7
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeKeyCursorControl:Landroid/preference/ListPreference;
    ...
    .line 615
    :cond_8
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationRecentsLongPressAction:Landroid/preference/ListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 717
    iget-object v2, p0, Lcom/android/stockssettings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;
    ...
    .line 722
    :cond_3
    iget-object v2, p0, Lcom/android/stockssettings/ButtonSettings;->mVolumeControlRingStream:Landroid/preference/SwitchPreference;
    ...
    .line 726
    :cond_5
    iget-object v2, p0, Lcom/android/stockssettings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
    ...
    .line 728
    iget-object v2, p0, Lcom/android/stockssettings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;
    ...
    invoke-static {v1, v2}, Lcom/android/stockssettings/ButtonSettings;->writeDisableNavkeysOption(Landroid/content/Context;Z)V

    .line 730
    invoke-direct {p0}, Lcom/android/stockssettings/ButtonSettings;->updateDisableNavkeysOption()V

    .line 731
    invoke-direct {p0, v0}, Lcom/android/stockssettings/ButtonSettings;->updateDisableNavkeysCategories(Z)V

    .line 732
    iget-object v1, p0, Lcom/android/stockssettings/ButtonSettings;->mHandler:Landroid/os/Handler;

    new-instance v2, Lcom/android/stockssettings/ButtonSettings$1;

    invoke-direct {v2, p0}, Lcom/android/stockssettings/ButtonSettings$1;-><init>(Lcom/android/stockssettings/ButtonSettings;)V
    ...
    .line 740
    :cond_6
    iget-object v1, p0, Lcom/android/stockssettings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;

    if-ne p2, v1, :cond_7

    .line 741
    invoke-direct {p0}, Lcom/android/stockssettings/ButtonSettings;->handleTogglePowerButtonEndsCallPreferenceClick()V

    goto :goto_2

    .line 743
    :cond_7
    iget-object v1, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;

    if-ne p2, v1, :cond_1

    .line 744
    invoke-direct {p0}, Lcom/android/stockssettings/ButtonSettings;->handleToggleHomeButtonAnswersCallPreferenceClick()V
...
.method public onResume()V
    ...
    .line 475
    iget-object v6, p0, Lcom/android/stockssettings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
    ...
    :cond_0
    iget-object v6, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
    ...
    :goto_1
    iget-object v4, p0, Lcom/android/stockssettings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
